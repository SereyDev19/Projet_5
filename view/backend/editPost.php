...
<div id="dashboard" class="container">
    <header class="row col-sm-12">
        <div class="page-header">
            ...
            <h2 class="white">Modifier un article</h2>
        </div>
    </header>
    ...
    <section class="col-sm-12">
            <div id="main">
                ...
                <form id="formNewPost" action="admin.php?action=modifyPost" method="post">
                    <div class="index">
                        <label for="index">Numéro de chapitre</label><br/>
                        <?= '<input type="number" id="index" name="index" value="' .$post['chapnumber']. '"/>' ;?>
                    </div>
                    <div class="title">
                        <label for="title">Titre</label><br/>
                        <?= '<input type="text" id="title" name="title" value="' .$post['title']. '"/>' ;?>
                    </div>
                    <div class="id du post">
